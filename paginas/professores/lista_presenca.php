...
<title><?php echo $info["nome_escola"]; ?> | Lista de presença</title>
...
<?php include "navbar.php" ?>
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="active">Listas de presença</li>
        </ol>
...
<script src="js/lista_presenca.js" type="text/javascript"></script>
</body>
</html>